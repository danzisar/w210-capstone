...
def _cleanup_args(args):
    ...
    if args.use_random_crop is None:
        if args.dataset in ['CIFAR10', 'CIFAR100','CIFAR102','CIFAR10_10K','CIFAR10_30K', 'CIFAR102_30K']:
    ...
    # data
    if args.dataset in ['CIFAR10', 'CIFAR102', 'CIFAR10_10K', 'CIFAR10_30K', 'CIFAR102_30K']:
