...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='CIFAR10',
        choices=['CIFAR10', 'CIFAR100', 'CIFAR102', 'CIFAR10_10K', 'CIFAR10_30K', 'CIFAR102_30K', 'KMNIST'])
#     parser.add_argument(
#         '--testset',
#         type=str,
#         default='CIFAR10',
...
def main():
    ...
    for epoch, seed in zip(range(1, optim_config['epochs'] + 1), epoch_seeds):
        ...
        # test
        # test_log = test(epoch, model, test_criterion, test_loaders, run_config, writer)
        ...
        # update state dictionary with test accuracy
        # state = update_state(state, epoch, epoch_log['test'][config['data_config']['dataset']]['accuracy'], model, optimizer)
        # update state dictionary with train accuracy
        state = update_state(state, epoch, epoch_log['train']['accuracy'], model, optimizer)
