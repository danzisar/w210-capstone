...
def _get_dataset_stats(
    ...
    elif name == 'CIFAR10_CM_1.5':   # Added by W210 Team
        # RGB
        mean = np.array([0.48900641, 0.47970266, 0.47680648])  # Should be based on training dataset
        std = np.array([0.00065567, 0.00068278, 0.00070836])
